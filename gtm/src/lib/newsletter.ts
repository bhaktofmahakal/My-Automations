...
<body style="margin: 0; padding: 0; background-color: #18181b; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">
  <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
    ...
    <div style="background-color: #27272a; border: 1px solid #3f3f46; border-radius: 12px; padding: 24px; margin-bottom: 24px;">
      ...
      <a href="https://github.com/bhaktofmahakal/My-Automations/leaderboard?prompt=${promptOfWeek.id}" style="display: inline-block; background-color: #f59e0b; color: #000000; padding: 10px 20px; text-decoration: none; border-radius: 8px; font-weight: 500; font-size: 14px;">Copy This Prompt →</a>
    </div>
      ...
      <div style="background-color: #27272a; border: 1px solid #3f3f46; border-radius: 12px; padding: 16px;">
        ${newPrompts.map((p) => `
          <div style="padding: 8px 0;">
            <a href="https://github.com/bhaktofmahakal/My-Automations/leaderboard?prompt=${p.id}" style="color: #ffffff; text-decoration: none; font-size: 14px;">${p.title}</a>
    ...
    <div style="text-align: center; padding-top: 24px; border-top: 1px solid #3f3f46;">
      <p style="color: #71717a; font-size: 12px; margin: 0 0 8px 0;">
        <a href="https://github.com/bhaktofmahakal/My-Automations" style="color: #71717a; text-decoration: none;">github.com/bhaktofmahakal/My-Automations</a>
      </p>
  ...
  for (const batch of batches) {
    try {
      await resend.batch.send(
        batch.map((email) => ({
          from: 'GTM Skills <weekly@github.com/bhaktofmahakal/My-Automations>',
          to: email,
          subject,
          html: htmlContent,
        }))
