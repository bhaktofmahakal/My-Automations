...
export function generatePromptsJson() {
  ...
  return {
    ...
    source: 'https://github.com/bhaktofmahakal/My-Automations',
    repository: 'https://github.com/bhaktofmahakal/My-Automations/tree/main/gtm',
    license: 'MIT',
    categories: {
    ...
    prompts: allPrompts.map((p) => ({
      ...
      url: `https://github.com/bhaktofmahakal/My-Automations/prompts/${p.id}`,
      api_url: `https://api.github.com/bhaktofmahakal/My-Automations/v1/prompts/${p.id}`,
    })),
  };
}
