...
export async function sendWelcomeEmail(email: string) {
  ...
  return resend.emails.send({
    from: 'GTM Skills <utsavmishraa005@gmail.com>',
    to: email,
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
        ...
        <a href="https://github.com/bhaktofmahakal/My-Automations" style="display: inline-block; background: #18181b; color: white; padding: 12px 24px; text-decoration: none; border-radius: 8px; font-weight: 500; margin-top: 20px;">
          Browse Prompts
        </a>
