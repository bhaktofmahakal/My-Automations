...
const mcpData = {
  server: {
    ...
    github: 'https://github.com/bhaktofmahakal/My-Automations/tree/main/gtm/tree/main/mcp-server',
    install: {
      clone: 'git clone https://github.com/bhaktofmahakal/My-Automations/tree/main/gtm.git && cd My-Automations/mcp-server && npm install && npm run build',
    ...
    claude_desktop: {
      ...
      example: {
        mcpServers: {
          gtm: {
            command: 'node',
            args: ['/path/to/My-Automations/gtm/mcp-server/dist/index.js'],
          },
        },
      },
    },
...
export async function GET() {
  const response = {
    data: mcpData,
    documentation: 'https://github.com/bhaktofmahakal/My-Automations/free-tools/mcp-server',
    meta: {
      api_version: 'v1',
