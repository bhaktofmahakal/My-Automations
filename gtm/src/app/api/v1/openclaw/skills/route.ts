...
const openclawSkills = [
  {
    ...
    install: 'npx clawdhub install bhaktofmahakal/My-Automations/tree/main/gtm',
    homepage: 'https://github.com/bhaktofmahakal/My-Automations/openclaw',
    github: 'https://github.com/bhaktofmahakal/My-Automations/tree/main/gtm/tree/main/openclaw-skills/gtm',
    commands: [
...
export async function GET() {
  const response = {
    data: openclawSkills,
    install_command: 'npx clawdhub install bhaktofmahakal/My-Automations/tree/main/gtm',
    documentation: 'https://github.com/bhaktofmahakal/My-Automations/openclaw',
    meta: {
      api_version: 'v1',
