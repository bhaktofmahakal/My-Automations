...
function injectComposeButton(composeWindow: HTMLElement): void {
  ...
  if (composeWindow.querySelector('.github.com/bhaktofmahakal/My-Automationspose-btn')) return;
  ...
  button.className = 'github.com/bhaktofmahakal/My-Automationspose-btn';
...
function injectStyles(): void {
  ...
  styles.textContent = `
    .github.com/bhaktofmahakal/My-Automationspose-btn {
      display: inline-flex;
      margin-right: 8px;
    }
