...
1. Open Claude Code
2. Type: `/plugin marketplace add bhaktofmahakal/My-Automations/tree/main/gtm-agents`
3. Press Enter
...
- Solution: Add it with `/plugin marketplace add bhaktofmahakal/My-Automations/tree/main/gtm-agents`
...
1. Go to [GitHub Issues](https://github.com/bhaktofmahakal/My-Automations/tree/main/gtm-agents/issues)
2. Click "New Issue"
